...
if __name__ == '__main__':
    test_input = 'E:/Machine Learning/hw7/handout/testwords.txt' #sys.argv[1]
    index_to_word = 'E:/Machine Learning/hw7/handout/index_to_word.txt' #sys.argv[2]
    index_to_tag = 'E:/Machine Learning/hw7/handout/index_to_tag.txt' #sys.argv[3]
    hmmprior = 'E:/Machine Learning/hw7/handout/hmmprior.txt' #sys.argv[4]
    hmmemit = 'E:/Machine Learning/hw7/handout/hmmemit.txt' #sys.argv[5]
    hmmtrans = 'E:/Machine Learning/hw7/handout/hmmtrans.txt' #sys.argv[6]
    predicted_file = 'E:/Machine Learning/hw7/fulldata/1.txt' #sys.argv[7]
    metric = 'E:/Machine Learning/hw7/fulldata/2.txt' #sys.argv[8]
