...
def main():
    formatted_train_input = '4.txt'#sys.argv[1]
    formatted_validation_input = 'formatted_valid1.tsv'#sys.argv[2]
    formatted_test_input = '5.txt'#sys.argv[3]
    dict_input = 'dict.txt'#sys.argv[4]
    train_out = '1.txt'#sys.argv[5]
    test_out = '2.txt'#sys.argv[6]
    metrics_out = '3.txt'#sys.argv[7]
    num_epoch = 60#int(sys.argv[8])
